...
public class TransactionManagerConfig {
    ...
    private static final String AOP_POINTCUT_EXPRESSION = "execution(* com.huiyi.campus.web.sys.service.*.*(..)) "+
    "|| execution(* com.huiyi.campus.web.health.service.*.*(..)) " + "|| execution(* com.huiyi.campus.web.common.service.*.*(..))";

    private final PlatformTransactionManager transactionManager;

    TransactionManagerConfig(PlatformTransactionManager transactionManager) {
